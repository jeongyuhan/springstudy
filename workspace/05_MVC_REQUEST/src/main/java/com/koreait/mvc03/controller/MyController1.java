...
public class MyController1 {
	...
	public String a() {
		...
		return "index"; // 기본적인 이동방식은 forward이다.
	}
	
	@RequestMapping("view01")
	// @RequestMapping("/view01") // 슬래시(/)로 시작해도 상관 없다.
	public String b() {
		return "folder01/view01"; // return에 적어주는것은 jsp의 경로이다.
		// "/WEB-INF/views와 .jsp는 자동으로 붙는다는것을 알고있어야한다.
	...
	// 앞으로는 매핑 값을 작성할 때 시작 슬래시(/)를 넣지 않는다.
