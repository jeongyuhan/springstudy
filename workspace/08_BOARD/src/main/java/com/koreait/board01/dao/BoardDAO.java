...
public class BoardDAO {
	...
	private BoardDAO() {
		try {
			...
			dataSource = (DataSource)context.lookup("java:comp/env/jdbc/oracle"); // lookup("java:comp/env/ 까지는 항상 같다.
																				  // jdbc/oracle 부분은 Resource의 name이다.(context.xml에 있는 <Resource>의 name 부분에 따라 달라진다.)
		} catch(Exception e) {
			e.printStackTrace();
		}
	}
